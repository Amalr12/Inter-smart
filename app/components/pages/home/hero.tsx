  ...
  return (
    <section className="relative min-h-[70vh] overflow-hidden md:min-h-screen">
      <div
        ...
        style={{ backgroundImage: "url('/herobg.jfif')"}}
      />
      ...
      <main className="relative z-10 grid min-h-[70vh] w-full items-center md:min-h-screen md:grid-cols-[4fr_2fr] md:px-10 px-3">
        <div className="flex flex-col items-start justify-center space-y-4 px-5 py-12 text-white md:space-y-6 md:px-8 md:py-16 lg:px-16">
          <h1
            className={`max-w-3xl text-balance text-xl mt-5 font-semibold leading-tight md:text-5xl lg:text-6xl ${poppins.className}`}
            data-aos="fade-up"
            data-aos-delay="100"
          >
          ...
          <p
            className={`max-w-2xl text-xs font-medium leading-7 text-justify md:text-lg lg:text-xl ${poppins.className}`}
            data-aos="fade-up"
            data-aos-delay="200"
          >
          ...
          <button
            className={`rounded-3xl bg-white px-6 py-3 cursor-pointer text-xs md:text-sm font-semibold uppercase text-[#182434] transition hover:bg-[#182434] hover:text-white hover:outline hover:outline-white md:px-8 md:py-3 md:text-base ${poppins.className}`}
            data-aos="fade-up"
            data-aos-delay="300"
          >
            Reach us
