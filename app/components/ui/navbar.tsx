...
export default function Navbar() {
    ...
    return (
        <nav className="absolute top-0 left-0 z-50 w-full bg-transparent text-[#F1F1F1]">
            ...
            {open && (
                <div className="absolute left-0 right-0 top-full w-full bg-[#182434] p-4 shadow-lg lg:hidden">
